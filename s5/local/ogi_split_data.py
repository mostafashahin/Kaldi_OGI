...
def ArgParser():
    ...
    parser.add_argument('-t','--train_portion', dest='tr_pr', help='The persentatge of speakers used for training', type=float, default=-1)
    parser.add_argument('-s','--test_portion', dest='tst_pr', help='The persentatge of speakers used for testing', type=float, default=0.15)
    parser.add_argument('-d','--dev_portion', dest='dev_pr', help='The persentatge of speakers used for developing', type=float, default=0.15)
